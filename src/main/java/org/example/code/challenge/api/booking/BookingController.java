package org.example.code.challenge.api.booking;

import org.example.code.challenge.api.booking.request.CreateBookingRequest;
import org.example.code.challenge.api.booking.request.BookingRequest;
import com.statista.code.challenge.api.booking.response.*;
import org.example.code.challenge.api.booking.response.BookingResponse;
import org.example.code.challenge.api.booking.response.DepartmentBookingsResponse;
import org.example.code.challenge.api.booking.response.business.DoBusinessResponse;
import org.example.code.challenge.api.booking.response.currency.CurrenciesResponse;
import org.example.code.challenge.api.booking.response.currency.CurrencySumResponse;
